...
function reassignTask(){
	...
	$agencyID = isset($_POST['agency_id']) ? $_POST['agency_id'] : "";
	$postID = $_GET['postID'];
	...
	if($agencyID == ""){
		echo "<script type='text/javascript'>alert('No agency assigned. Please try again!'); window.location='homepage/newsfeed.php';</script>";
		return;
	}else{
