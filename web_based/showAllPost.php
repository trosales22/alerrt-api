			...
			while($row = mysqli_fetch_assoc($result)){
						...
						$valuesComments .= 	'<div class="col-md-12" style="margin-bottom: 25px;">' .
						              '<div class="media">' .
						                ...
						                '<div class="media-body">' .
						                  '<h4 class="media-heading">' . $rowComments['CommentBy_Fullname'] . '<br><span style="font-size: 15px;">' . timeAgo($rowComments['DateAndTimeCommented']) . '</span></h4>' .
						                  '<hr width="100%">' .
				...
				$values .= 	'<div class="col-md-12" style="margin-bottom: 25px;">' .
				              '<div class="media">' .
				                ...
				                '<div class="media-body">' .
				                  '<h4 class="media-heading">' . $row['TopicPostedBy_Fullname'] . '<br><span style="font-size: 15px;">' . timeAgo($row['TopicDateAndTimePosted'] - 5) . '</span></h4>' .
				                  '<hr width="100%">' .
				                  '<p>' .
